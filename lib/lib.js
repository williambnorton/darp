...
function dumpState() {
    redisClient.hgetall("mint:0",function(err,me) {
       ...
       redisClient.hgetall("mint:1",function(err,genesis) {
          ...
          redisClient.hgetall("DEVOPS:DEVOPS.1",function(err,genesisGroup) {
            console.log(ts()+"dumpState genesisGroupPulseLabel genesisGroup="+dump(genesisGroup));
            redisClient.hgetall("MAZORE:DEVOPS.1",function(err,OREGroup) {
...
module.exports = { now: now, ts: ts, dump: dump, Log: Log, checkNoiaSWHash: checkNoiaSWHash, mintList: mintList, SRList:SRList, getMints, getOwls, makeYYMMDD, dumpState  };
