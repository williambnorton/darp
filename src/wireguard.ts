...
export function addMyWGStanza(geo:String, ipaddr:String, port:String, mint:number, publickey:String) : string {
...
export function addPeerWGStanza(geo:String, ipaddr:String, port:String, mint:number, publickey:String) : string {
    var line1="#\n" + 
