...
//
//var HOST='127.0.0.1';
var genesisSR = lib_1.getGenesis();
...
var me = {
    geo: "HOME",
    mint: 2,
    noiawallet: "3BjDVN35cZdsRzyo4Q9VY3LFy1RteNBxPz",
    genesis: "104.42.192.234:65013:",
    group: "HOME.1",
    ipaddr: " 71.202.2.184",
    port: "65013",
    publickey: "lvcLDqpzCmTdAxR9YCOeyubP8DAO8dh9svfRdiV8JEE",
    noialen: 77855
};
redisClient.hmset("me", me);
redisClient.hgetall("me", function (err, myRecord) {
    if (typeof myRecord == "undefined")
        return console.log("redis has no me ");
    if (typeof myRecord.mint == "undefined")
        return console.log("redis has no me.mint ");
