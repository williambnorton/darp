...
function getMatrixTable(darpMatrix, callback) {
    ...
    expressRedisClient.scan(cursor, 'MATCH', 'darp-*', 'COUNT', '1000', function (err, reply) {
        ...
        for (var n in reply[1]) {
            ...
            console.log(lib_1.ts() + "getMatrixTable src=" + src + " dst=" + dst + " owl=" + owl);
                ...
                for (var row in pulses) {
                    ...
                    for (var col in pulses) {
                        ...
                        if (owl == "")
                            ...
                            txt += '<td class="XXXXX" id="' + entryLabel + '">' + '<a href="http://' + me.ipaddr + ':' + me.port + '/graph?dst=' + me.mint + '&src=' + rowEntry.srcMint + "&group=" + me.group + '" >' + owl + "</a>" + " ms</td>";
                        else
