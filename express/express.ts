           ...
           getMatrixTable(null, function(OWLMatrix) {
               ...
               for (var row in pulses) {
                   ...
                   getIPport(rowEntry.srcMint, function (IPnPort) {
                        ...
                        var lastCol=""
                        for (var col in pulses) lastCol=col;
                        ...
                        for (var col in pulses) {
                            ...
                            else if (count<100) txt += '<td class="XXXXX" id="' + entryLabel + '">' + '<a  target="_blank" href="http://' + IPnPort + ':' + me.port + '/graph?dst=' + me.mint + '&src=' + rowEntry.srcMint + "&group=" + me.group + '" >' + owl + "</a>" + " ms</td>"
                                    else txt += '<td id="' + entryLabel + '">' + owl + "</td>"

                            if (col==lastCol) txt += "</tr>";

                        }
                        if (row==lastCol) txt += "</table>";
