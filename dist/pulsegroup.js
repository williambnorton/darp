    ...
    function AugmentedPulseGroup(config, pulseGroup) {
        ...
        this.recvPulses = function (incomingMessage, ipaddr, port) {
            ...
            if (incomingPulse.msgType == "11") {
                ...
                var pongMsgEncoded = lib_1.now() + ",12," + _this.config.VERSION + "," + _this.mintTable[1].ipaddr + "," + _this.mintTable[1].port + "," + _this.mintTable[1].publickey + "," + _this.mintTable[1].geo + "," + (_this.mintTable[1].geo + ".1") + "," + _this.mintTable.length + ",and,stuff,here";
