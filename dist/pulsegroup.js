            ...
            if ((m != "0") && m != "1" && this.mintTable[m] && this.mintTable[m].lastPulseTimestamp != 0) { //ignore mintTable[0]
                ...
                if (elapsedMSincePulse > 2 * newPulseGroup.cycleTime * 1000) { //timeout after 2 seconds
                    ...
                    if (newPulseGroup.isGenesisNode()) { /*GENESIS ONLY*/
                        ...
                        if (age > 30 * 1000) {
                            logger_1.logger.error("Genesis node disappeared. age of = " + age + " ms Exit, our work is done. Exitting. newpulseGorup=" + lib_1.dump(newPulseGroup));
                            process.exit(36);
                        }
            ...
            if (incomingPulseEntry !== undefined) {
                ...
                if (incomingPulseEntry.mint == 1) { //if pulseGroup owner, make sure I have all of his mints
                    ...
                    if (incomingPulse.version != me.version) {
                        logger_1.logger.error("Group Owner has newer? software than we do my SW version: " + me.version + " vs genesis: " + incomingPulse.version + "). QUit, Rejoin, and reload new SW");
        ...
        var _loop_1 = function () {
            ...
            child_process.exec(pingCmd, function (error, stdout, stderr) {
                ...
                if (state == 1) {
                    ...
                    console.log(lib_1.ts() + "address=" + address + " octets3=" + octets[3] + " octet4=" + octets[4] + " mint=" + mint + " ary=" + ary[8] + );
                    if (ary[6] == "bytes") {
                        ...
                        if (typeof timeEquals != "undefined") {
                            ...
                            console.log("**** adress: " + address + " to see who replied... measurertt(): " + me.geo + " - " + pulseEntry.geo + " rtt = " + rtt);
