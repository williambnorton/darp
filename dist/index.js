...
app.get('/nodefactory', function (req, res) {
    ...
    if (myPulseGroup.groupOwner != me.geo) {
        ...
        var newPulse = new pulsegroup_1.PulseEntry(1, geo, config.GEO + ".1", incomingIP.toString(), port, config.VERSION, incomingTimestamp); //makePulseEntry(mint, geo, group, ipaddr, port, version) 
        var newPulseGroup = new pulsegroup_1.PulseGroup(me, me, newPulse); //my pulseGroup Configuration, these two me and genesis are the start of the mintTable
