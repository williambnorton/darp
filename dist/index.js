...
app.get(['/pulsegroups', '/state', '/me'], function (req, res) {
    ...
    var filename = "/tmp/" + me.ipaddr + "." + me.port + '.json';
...
app.get('/nodefactory', function (req, res) {
    ...
    myPulseGroup.pulses[geo + ":" + myPulseGroup.groupName] = new pulsegroup_1.PulseEntry(newMint, geo, myPulseGroup.groupName, String(incomingIP), port, config.VERSION, bootTimestamp);
