    ...
    if (typeof req.params.pulsegroup != "undefined") {
        ...
        for (var pulseGroup in myPulseGroups) {
            if (myPulseGroups[pulseGroup].groupName == req.params.pulsegroup) {
                ...
                console.log("pulsegroup delivering cloned pulseGroup with customer mint0 for new mint #" + mint + lib_1.dump(clonedPulseGroup));
...
getMyPulseGroupObject(GENESIS, PORT, function (newPulseGroup) {
    ...
    newPulseGroup.timeout = function () {
        ...
        if (startingNodeCount != newPulseGroup.pulses.length) {
            ...
            console.log("timeout(): nodeC0unt Changed setting newPulseGroup.nodeCount=" + newPulseGroup.nodeCount);
        }
