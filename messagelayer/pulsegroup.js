            ...
            if (srcMintEntry != null) {
                ...
                for (var dest in pulseGroup.matrix[src]) {
                    ...
                    if (destMintEntry != null)
                        txt += '<td class="' + src + "-" + srcMintEntry.geo + ' ' + srcMintEntry.geo + ' ' + destMintEntry.geo + '">' + '<a target="_blank" href="http://' + destMintEntry.ipaddr + ':' + destMintEntry.port + '/graph/' + srcMintEntry.geo + '/' + destMintEntry.geo + '" >' + pulseGroup.matrix[src][dest] + " ms</a></td>";
                    else
