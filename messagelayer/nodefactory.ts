...
var pulseGroup = {                 //my pulseGroup Configuration
    ...
    rc: 0,
    isGenesisNode: 1,   //true if I own this group & control population   
    ts: now(), 
    ...
    var req = http.get(url, function (res) {
        ...
        res.on('end', function () {
            ...
            if (pulseGroup.isGenesisNode==true) {
                console.log(ts()+"getPulseGroup(): GENESIS node configured");
                //*********** GENESIS NODE CONFIGURED **********/
                callback(pulseGroup);            
                return;
            } 
            console.log(ts()+"getPulseGroup(): Configuring non-genesis node ... config.isGenesisNode="+pulseGroup.isGenesisNode);
    ...
    getPulseGroup("71.202.2.184","65013", function (pulseGroup) {
       ...
       //pulseGroup.pulse = function() {
        ...
        pulseGroup.pulse=function() {
            ...
            this.forEachNode(function(index:string,nodeEntry:PulseEntry) {
